        ...
        return ([
            {
                ...
                "data": {
                    ...
                    "dr_volume": get_dr_volume(bid.start_time, bid.end_time),
                    "cbl": get_cbl(bid.start_time, bid.end_time),
                    "price": bid.price,
                    "settlement": bid.settlement,
                    "result": bid.result,
                    "status": bid.status,
                    "rate": (
                        "{:.2f}".format(get_dr_volume(bid.start_time, bid.end_time) / bid.volume * 100)
                    ),
