...
res = requests.post("http://140.116.247.117:5000/bidsubmit", headers={"Authorization":bearer}, json={"bid_type":"sell", "start_time":"2020/06/27 20", "end_time":"2020/06/28 00", "value":20, "price":6.8})
