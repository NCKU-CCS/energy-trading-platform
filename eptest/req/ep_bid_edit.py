...
res = requests.put("http://140.116.247.117:5000/bidsubmit", headers={"Authorization":bearer}, json={"id":"26256af9-104a-459a-b1a9-3b6b115d1252", "bid_type":"buy", "start_time":"2020/06/27 20", "end_time":"2020/06/28 00", "value":20, "price":6.0})
